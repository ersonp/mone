...
<div class="flex flex-wrap items-center justify-between px-2">
	<div class="flex flex-wrap lg:flex-row lg:justify-between px-2 w-full">
		<div class="flex-1 text-sm text-muted-foreground mb-2 lg:mb-0" id="one">
			{Object.keys($selectedDataIds).length} of{' '}
			{$rows.length} row(s) selected.
		</div>
		<div class="flex items-center justify-center space-x-2 mb-2 lg:mb-0" id="two">
