...
export const investmentSchema = z.object({
    ...
    return_rate: z.coerce.number().refine(value => value !== 0, { message: "Return rate should not be zero." }),
    return_type: z.string().refine((v) => v, { message: "Return Type is required." }),
    inv_amount: z.coerce.number().refine(value => value !== 0, { message: "Inv amount should not be zero." }),
    return_amount: z.coerce.number().refine(value => value !== 0, { message: "Return amount should not be zero." }),
